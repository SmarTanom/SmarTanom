...
class DeviceAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'device_serial', 'device_name', 'status', 'is_bound', 'bound_email', 'created_at', 'updated_at')
    list_filter = ('status', 'is_bound')  # Filter by status and binding status
    search_fields = ('device_name', 'device_serial', 'bound_email')
    ordering = ('-created_at',)
