// Reusable SVG Icon Components for Dashboard
// Lightweight, no external deps. Each accepts size (number|string) and color.
...
// Aggregate map if dynamic selection needed
export const Icons = {
  leaf: IconLeaf,
  alert: IconAlert,
  wifi: IconWifi,
